...
public class PageLevelComparisonResult {
    ...
    private List<guraa.pdfcompare.service.PageComparisonResult> pageComparisonResults = new ArrayList<>();
    ...
    public PageLevelComparisonResult(List<PagePair> matchedPages, 
                                    List<guraa.pdfcompare.service.PageComparisonResult> pageComparisonResults, 
